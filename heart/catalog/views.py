...
def image(request):
	image_data = open("C:/Users/Akash Suresh/Desktop/web tech2/heart_illustration.jpg", "rb").read()
...
def video(request):
    video_data = open("C:/Users/Akash Suresh/Desktop/web tech2/heart.mp4", "rb").read()
